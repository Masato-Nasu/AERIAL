...
// sw-aerial-v98.js — scope: /v98/ only
const CACHE = 'aerial-v98';
const ASSETS = [
  './',
  './index.html?v=98',
  './hum-theremin-recorder.html?v=98',
  './manifest.json?v=98',
  './icon-192.png',
  './icon-512.png',
  './Chime.mp3'
...
self.addEventListener('fetch', (e) => {
  ...
  if (url.pathname.endsWith('.html') || url.pathname.endsWith('/v98/') || url.pathname.endsWith('/v98')) {
    e.respondWith((async()=>{
      try {
